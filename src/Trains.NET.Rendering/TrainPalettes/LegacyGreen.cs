...
{
    internal class LegacyGreen : ITrainPalette
    {
        ...
        public Colors FrontSectionStartColor => Colors.LegacyDarkGreen;

        public Colors FrontSectionEndColor => Colors.LegacyLightGreen;
    }
}
