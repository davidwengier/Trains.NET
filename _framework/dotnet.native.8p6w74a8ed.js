...
// include: /home/runner/.dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
// end include: /home/runner/.dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
var _mono_aot_Trains_NET_Engine_get_method = Module['_mono_aot_Trains_NET_Engine_get_method'] = (a0) => (_mono_aot_Trains_NET_Engine_get_method = Module['_mono_aot_Trains_NET_Engine_get_method'] = wasmExports['mono_aot_Trains_NET_Engine_get_method'])(a0);
var _mono_aot_Trains_NET_Instrumentation_get_method = Module['_mono_aot_Trains_NET_Instrumentation_get_method'] = (a0) => (_mono_aot_Trains_NET_Instrumentation_get_method = Module['_mono_aot_Trains_NET_Instrumentation_get_method'] = wasmExports['mono_aot_Trains_NET_Instrumentation_get_method'])(a0);
var _mono_aot_Trains_NET_Rendering_get_method = Module['_mono_aot_Trains_NET_Rendering_get_method'] = (a0) => (_mono_aot_Trains_NET_Rendering_get_method = Module['_mono_aot_Trains_NET_Rendering_get_method'] = wasmExports['mono_aot_Trains_NET_Rendering_get_method'])(a0);
var _mono_aot_Trains_NET_Rendering_Skia_get_method = Module['_mono_aot_Trains_NET_Rendering_Skia_get_method'] = (a0) => (_mono_aot_Trains_NET_Rendering_Skia_get_method = Module['_mono_aot_Trains_NET_Rendering_Skia_get_method'] = wasmExports['mono_aot_Trains_NET_Rendering_Skia_get_method'])(a0);
var _mono_aot_BlazingTrains_get_method = Module['_mono_aot_BlazingTrains_get_method'] = (a0) => (_mono_aot_BlazingTrains_get_method = Module['_mono_aot_BlazingTrains_get_method'] = wasmExports['mono_aot_BlazingTrains_get_method'])(a0);
