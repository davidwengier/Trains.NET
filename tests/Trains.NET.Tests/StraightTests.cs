...
namespace Trains.NET.Tests
{
    public class StraightTests : TestBase
    {
        ...
        [Theory]
        [InlineData(TrainAngle.TrainFacingUp, 1, 3, 1, 1)]
        [InlineData(TrainAngle.TrainFacingDown, 1, 1, 1, 3)]
        ...
        [Theory]
        [InlineData(TrainAngle.TrainFacingRight, 1, 1, 3, 1)]
        [InlineData(TrainAngle.TrainFacingLeft, 3, 1, 1, 1)]
        ...
        [Theory]
        [InlineData(TrainAngle.TrainFacingRight, 1, 2, 3, 2)]
        [InlineData(TrainAngle.TrainFacingLeft, 3, 2, 1, 2)]
        [InlineData(TrainAngle.TrainFacingUp, 2, 3, 2, 1)]
        [InlineData(TrainAngle.TrainFacingDown, 2, 1, 2, 3)]
